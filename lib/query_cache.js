...
query_cache_get = function (_type, _modules, _query, _expire, _callback) {
    ...
    tableQueryCache.findOne({
        ...
        if (_cache !== null) {
            ...
            if (typeof(DEBUG.not_found) === "boolean" && DEBUG.not_found === true) {
        ...
        if (_cache === null
            ...
            if (typeof(DEBUG.get_from) === "boolean" && DEBUG.get_from === true) {
...
query_cache_set = function (_type, _modules, _query,_response, _error, _callback) {
    ...
    var _then = function () {
        if (typeof(DEBUG.set_from) === "boolean" && DEBUG.set_from === true) {
