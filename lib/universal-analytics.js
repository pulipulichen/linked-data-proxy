...
ua_set_headers = function (_req, _res) {
    ...
    visitor = ua(CONFIG.ga_track_code, _uuid).debug();
    visitor.set('userId', _uuid);
    visitor.set('uid', _uuid);
    visitor.set('UUID', _uuid);
    visitor.set(CONFIG.ga_user_id_dimension, _uuid);
    //console.log(["ua_set_headers", CONFIG.ga_user_id_dimension, _uuid]);
};
...
ua_event_add_term = function (_term) {
    ...
    //console.log("ua_event_add_term: " + _parameters.ea);
    visitor.event(_parameters).send();
};
