...
ua_event = function (_module, _query, _has_response, _is_cache) {
    var _parameters = _build_event_parameters(_module, _query, _has_response, _is_cache);
...
ua_event_vote = function (_module, _query, _score) {
    var _parameters = _build_event_parameters(_module, _query);
    _parameters.el = "vote";
    _parameters.ev = _score;
