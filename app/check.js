...
app.get('/check/:modules', function (_req, _res) {
    ...
    //var _response_cache = _req.session.response_cache;
    //console.log(["get", _req.session]);
    //console.log(_req.session);
    ...
    if ((typeof (_response_id) === "number" || isNaN(_response_id) === false)) {
        ...
        //console.log(["get", _response_cache]);
        //_output_string = _response_id;
        _output_string = cookies.get("response_cache");
        //console.log('Cookies: ', cookies.get("response_cache"));
        res_display(_res, _output_string, _callback);
